 ...
 */
function serializeAsyncStorageWrite(fn) {
...
export async function addReminder(newReminder) {
...
export async function updateReminder(updatedReminder) {
    return serializeAsyncStorageWrite(async () => {
        ...
        const shouldCancelNotifications = originalReminder && (updatedReminder.isCompleted ||
...
export async function deleteReminder(id) {
    ...
    return serializeAsyncStorageWrite(async () => {
        ...
        if (reminderToDelete) {
            ...
            // Mark as deleted
            const updated = reminders.map(r => r.id === id
...
export async function permanentlyDeleteReminder(id) {
