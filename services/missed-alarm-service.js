...
class MissedAlarmService {
    ...
    async initialize() {
        ...
        const missedSubscription = DeviceEventEmitter.addListener('onMissedAlarm', this.handleMissedAlarm.bind(this));
        this.listeners.set('missedAlarm', missedSubscription);
        // Listen for delete action from native missed notification
        const deleteSubscription = DeviceEventEmitter.addListener('onMissedAlarmDeleted', this.handleMissedAlarmDeleted.bind(this));
    ...
    async handleMissedAlarmDeleted(data) {
    ...
    async showMissedNotification(data) {
