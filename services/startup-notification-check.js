...
export async function checkAndTriggerPendingNotifications() {
    ...
    try {
        ...
        const expiredRingerReminders = [];
        const remindersToReschedule = [];
 ...
 */
async function triggerPendingNotifications(reminders) {
    const { AlarmModule } = NativeModules;
 ...
 */
async function showExpiredRingerNotifications(reminders) {
    try {
