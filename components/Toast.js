...
export default function Toast({ message, visible, duration = 3000, onHide, type = 'info' }) {
    ...
    return (_jsx(Portal, { children: _jsx(View, { style: styles.portalOverlay, pointerEvents: "box-none", testID: "toast-overlay", children: _jsx(View, { style: styles.toastWrapper, children: _jsx(Pressable, { onPress: hideToast, accessibilityRole: "button", accessibilityLabel: "Dismiss notification", children: _jsx(Animated.View, { style: [styles.container, animatedStyle], testID: "toast", children: _jsx(Text, { style: [styles.message, { color: textColor }], children: message }) }) }) }) }) }));
}
